...
async def run_test():
    ...
    try:
        ...
        # -> Click the '＋ Create a trip' button (index 6) to open the trip creation flow.
        ...
        # -> Click the '← All trips' link (interactive element index 382) to return to the trips list so the new trip and dashboard trip count can be verified.
        # link "← All trips"
